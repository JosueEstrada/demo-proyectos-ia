# Uso
# python deteccion_rostros.py --rostro cascadas/haarcascade_frontalface_default.xml --imagen imagenes/obama.png
...
rectRostros = dr.detectar(gris, factorEscala=1.2, vecMin=5, tamMin=(30, 30))
print("Se encontró {} rostro(s)".format(len(rectRostros)))

# Dibujar los rectángulos de los rostros encontrados
